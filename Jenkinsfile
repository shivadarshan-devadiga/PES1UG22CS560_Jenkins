        ...
        stage('Clone Repository') {
            steps {
                script {
                    ...
                    sh 'git push https://shivadarshan-devadiga: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@github.com/shivadarshan-devadiga/PES1UG22CS560_Jenkins main'
                }
            }
        }
        stage('Build') {
